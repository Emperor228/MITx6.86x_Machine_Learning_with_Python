...
# print('softmax test_error(temp = 2)=', run_softmax_on_MNIST(temp_parameter=2))
# print('softmax test_error(temp = 1)=', run_softmax_on_MNIST(temp_parameter=1))
# print('softmax test_error(temp = 0.5)=', run_softmax_on_MNIST(temp_parameter=0.5))
...
# print("test_error_mod3",run_softmax_on_MNIST_mod3())
...
print("softmax regression with PCA18",test_error)
""" @author: YiWei """
...
temp_parameter = 1
train_x_centered, feature_means = center_data(train_x)
pcs10 = principal_components(train_x_centered)
train_pca10 = project_onto_PC(train_x, pcs10, n_components, feature_means)
test_pca10 = project_onto_PC(test_x, pcs10, n_components, feature_means)
...
""" @author: YiWei """
thetacube, cost_function_historycube = softmax_regression(train_cube, train_y, temp_parameter, alpha=0.3, lambda_factor=1.0e-4, k=10, num_iterations=150)
test_errorcube = compute_test_error(test_cube, test_y, thetacube, temp_parameter)
print("softmax regression with PCA10+cube",test_errorcube)
""" @author: YiWei """