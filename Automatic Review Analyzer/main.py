...
# Your code here
""" @author: YiWei """
test_accuracy = p1.classifier_accuracy(p1.pegasos,train_bow_features,test_bow_features,train_labels,test_labels,T=25,L=0.01)

print("pegasos best on test",test_accuracy)
""" @author: YiWei """
#-------------------------------------------------------------------------------
